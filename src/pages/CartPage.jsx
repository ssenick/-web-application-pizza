...
const CartPage = () => {
   ...
   const allProducts = useSelector(({cart}) => cart.allProducts)
   console.log(pizzasItems)
   const addedPizzas = Object.values(pizzasItems).map(item => item.items[0]);
         ...
         <div className="container container--cart">
            <div className="cart">
               ...
               <div className="content__items">
                  ...
                  <CartPizza totalCount={pizzasItems[item.id].totalPizzas} totalPrice={pizzasItems[item.id].totalPricePizzas} key={item.name} name={item.name}  types={item.types} sizes={item.sizes} imageUrl={item.imageUrl}/>
                  )}

               </div>
               <div className="cart__bottom">
                  <div className="cart__bottom-details">
                     <span> Total pizzas: <b>{allProducts} pieces.</b> </span>
